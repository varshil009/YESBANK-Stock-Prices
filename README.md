...
<p>This Project includes :-
  <li>Google Colab NoteBook for predicting Closing stock price. Goes through all data processes.</li>
</p>
...
After implementing various regression model and analyzing their respective performance matrics I came to the conclusion that the <b>"Linear Regression"</b> is  top performing models with respect to all the matrics.
